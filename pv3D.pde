...
pt L(float a, pt A, float b, pt B, float t){return new pt(A.x+((t-a)/(b-a))*(B.x-A.x), A.y+((t-a)/(b-a))*(B.y-A.y), A.z+((t-a)/(b-a))*(B.z-A.z));}// return new pt(A.x+((t-a)/(b-a))*(B.x-A.x), A.y+((t-a)/(b-a))*(B.y-A.y), A.z+((t-a)/(b-a))*(B.z-A.z)); 
